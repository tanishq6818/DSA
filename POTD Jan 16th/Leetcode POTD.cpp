...
public:
    ...
    bool insert(int val) {
        ...
        // Add the element to the vector and update the index in the map
    ...
    bool remove(int val) {
        ...
        int indexToRemove = elementIndex[val];

        elements[indexToRemove] = lastElement;
        elementIndex[lastElement] = indexToRemove;

        // Remove the element from the vector and the index from the map
        elements.pop_back();
