// Longest Repeating SubsequenceGiven string str, find the length of the longest repeating subsequence such that it can be found twice in the given string.
...
int LongestRepeatingSubsequence(string str){
            ...
            // Fill the dp table using LCS algorithm
            for (int i = 1; i <= n; i++) {
                for (int j = 1; j <= n; j++) {
